    ...
    return(
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md">
                <img src="./src/assets/thhh.jpg" alt="Quality Products" className="mx-auto mb-4" /> {/* Image */}
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md">
                <img src="./src/assets/fast-shipping.jpeg" alt="Fast Shipping" className="mx-auto mb-4" /> {/* Image */}
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md">
                <img src="./src/assets/shop.webp" alt="Excellent Customer Service" className="mx-auto mb-4" /> {/* Image */}
